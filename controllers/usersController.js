...
module.exports = {
    ...
    // Function to send email to admin when user wants to sponsor a child
    sponsorMe: (req, res) => {
        // Set nodemailer transporter constant with sending email account info    
        ...
        const mailOptions = {
            ...
            subject: 'A user would like to sponsor a child',
            text: `A user would like to sponsor a child. Below is the information submitted: \n
            User email: ${req.body.email}\n
            Child ID#: ${req.body.id}\n
            Child Name: ${req.body.kidFirstName} ${req.body.kidLastName}`
        }
        // Send email to admin
